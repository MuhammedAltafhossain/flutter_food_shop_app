...
class _SellerOrderListState extends State<SellerOrderList> {
  ...
  List<dynamic> list = [];
  List<String> items = ['Pending', 'Accepted', 'Rejected', 'Ongoing'];
  String currentItem = 'Pending';
                              ...
                              child: ListView.builder(
                                ...
                                itemBuilder: (BuildContext context, int a) {
                                  return ListTile(
                                    ...
                                    subtitle: Text(
                                        'Price: ${list[index]['product'][a]['price'].toString()}'),
                                    trailing: Text(
                              ...
                              child: DropdownButton<String>(
                                ...
                                onChanged: (String? newValue) {
                                  if (newValue != null) {
                                    ...
                                    final userId = list[index]['userId'];
                                    orderListController.updateOrderBySeller(orderId, newValue,userId);
                                  }
                                  ;
                                  setState(() {});
                                },
